export const dict = {
  ...
  "agents.empty": "No agent sessions match",
  "agents.keys": "j/k move · Enter open · n new · Esc clear",
  ...
  "agents.tree.expand": "Expand subagents",
  "agents.tree.collapse": "Collapse subagents",
  ...
  "agents.action.open": "Open session",
  "agents.action.dispatch": "New agent",
  "agents.action.close": "Close",
  "agents.attention.count": "{{count}} waiting on you",
  "agents.attention.question": "question",
  "agents.steer.placeholder": "Follow up… (⌘/Ctrl+Enter to send)",
  "agents.steer.placeholderLive": "Steer the running agent… (⌘/Ctrl+Enter to send)",
  "agents.steer.send": "Send",
  "agents.cost.show": "Spend",
  "agents.cost.title": "Spend & burn",
  "agents.cost.window": "Spend ({{window}})",
  "agents.cost.rate": "Burn rate",
  "agents.cost.tokens": "Token burn",
  "agents.cost.total": "Total spend",
  "agents.cost.model": "Provider / model",
  "agents.cost.allLoaded": "Loaded $",
  "agents.cost.none": "No priced messages in loaded sessions yet",
  "agents.cost.note": "Burn and per-model figures come from recently active sessions whose messages are loaded; total spend sums every session.",
}
